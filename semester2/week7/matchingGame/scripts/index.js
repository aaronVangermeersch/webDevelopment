const g = {
    ...
    matchCount: 2,
    cardCount: 2,
    TURN_SOUND: new Audio('assets/flip.mp3'),
...
const createWinModal = () => {
    ...
    title.textContent = 'GOEDZO!!!';
    modalContent.appendChild(title);

    const message = document.createElement('p');
    message.textContent = "Je Bent Gewonnen...";
...
const setup = () => {
    ...
    const availableContent = g.isAudioMode
        ? Array.from({ length: g.MAX_SOUNDS }, (_, i) => `sound${i}.mp3`)
